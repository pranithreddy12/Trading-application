...
class IntelligenceBriefAgent(BaseAgent):
    ...
    async def _generate_brief(self):
        ...
        if self.claude_client:
            brief_text = await self.claude_client.generate(prompt)
        else:
            # Fallback for testing
            brief_text = "## Market Regime\nbull_volatile\n## Portfolio Summary\n$15000.50"
        ...
        params = {
            ...
            "strategies_count": len(fetched_data["top_strategies"]) + len(fetched_data["bottom_strategies"])
        }
